...
RTD
```{r, echo = T, results='show'}
mod_rtd <- lmer(rtd ~ (1 | Origin) + AIKoppen + Water*Nitrogen + (1 | Sex) + (1 | Parent:Origin), data = bsdata_complete, family = binomial) #not for this ex., only RDPI
#added in AI Koppen
