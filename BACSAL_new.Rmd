...
KWRGR - (relative height growth rate) according to Kramer-Walter et al. 2016, uses (ln(f)-ln(i))/(t) (BACSAL t = 35 days)
```{r, echo = T, results='hide'}
bsdata %>%
...
#rearranging to use AIKoppen instead of Origin
bsdata %>% 
...
#make x-axis the aridity index - 2/22 meeting w/ Greg
#aridity is random effect
#run a lm (linear regression model) - 
#rts ~ N*W....
